// QUICK EMERGENCY FORCE SCRIPT - COPY INI KE BROWSER CONSOLE
...
const foods = [
  ...
  },
  {
    ...
    isPopular: true,
    ingredients: ["chicken", "flour", "chili", "garlic"],
  },
  {
    name: "Ramen",
    ...
    isPopular: true,
    ingredients: ["noodles", "broth", "egg", "vegetables"],
  },
];

console.log("🚨 EMERGENCY FORCE DATA IDENTIK START!");
console.log("Copy data ini ke Firebase Console manually:");
foods.forEach((food, index) => {
  console.log(`\n${index + 1}. ${food.name}:`);
  console.log(JSON.stringify(food, null, 2));
});
console.log("\n✅ 5 FOOD IDENTIK READY TO COPY!");
